...
export const en = {
  ...
  'group.join.paid.payer': 'Paying address (the 0x wallet you sent from — lets the owner bind the payment to you)',
...
export const zh: Record<keyof typeof en, string> = {
  ...
  'group.join.paid.payer': '付款地址（你付款所用的 0x 钱包，便于群主确认付款人是你）',

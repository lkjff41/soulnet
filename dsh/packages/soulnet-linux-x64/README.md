# soulnet-peer-linux-x64

The [soulnet](https://github.com/startupworld-ai/soulnet) light peer binary for Linux x64 (`bin/soulnet`), built with `go build -trimpath -ldflags "-s -w"` from `cmd/soulnet` of the same version.
